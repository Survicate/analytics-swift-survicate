...
if [ $branch != 'master' ] 
then
	echo "The 'master' must be the current branch to make a release."
	echo "You are currently on: $branch"
	exit 1
fi

versionFile="./sources/SurvicateDestination/Version.swift"
...
# update sources/SurvicateDestination/Version.swift
# - remove last line...
